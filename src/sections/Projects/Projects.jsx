  ...
  return (
    <section id="projects" className={styles.container}>
      ...
      <div className={styles.projectsContainer}>
        <ProjectCard
          src={pokedex}
          link="https://github.com/jpedrosaraiva/ProjetoReactApi"
          h3="Pokédex"
          p="Pokédex consumindo APIs"
        />
        <ProjectCard
          src={whatslab}
          link="https://github.com/jpedrosaraiva/Whatslab"
          h3="Whatslab"
          p="Ambiente de conversa"
        />
        <ProjectCard
          src={dragonBall}
          link="https://github.com/jpedrosaraiva/PersonagensDeDragonBallSuper"
          h3="Dragon Ball"
          p="Informações de personagens"
        />
        <ProjectCard
          src={ecommerce}
          link="https://github.com/jpedrosaraiva/EcommerceDeIPhones"
          h3="Hot Descontos"
